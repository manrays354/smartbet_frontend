        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
          ...
          <div>
             <div className="bg-[#1e293b] rounded-[2rem] p-8 border border-slate-800">
                ...
                <a href="https://t.me" target="_blank" rel="noreferrer" className="w-full bg-[#0088cc] text-white font-black py-3 rounded-2xl text-[10px] uppercase flex items-center justify-center">JOIN NOW</a>
             </div>
          </div>
          <div>
